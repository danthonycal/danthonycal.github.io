...
let now = new Date()
if (isSameDateAs(now, new Date(2022,3,22))){
    rightGuessString = WORDS[0];
} else if (isSameDateAs(now, new Date(2022,3,23))){
    rightGuessString = WORDS[1];
} else if (isSameDateAs(now, new Date(2022,3,24))){
    rightGuessString = WORDS[2];
} else if (isSameDateAs(now, new Date(2022,3,25))){
    rightGuessString = WORDS[3];
} else if (isSameDateAs(now, new Date(2022,3,26))){
